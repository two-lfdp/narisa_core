...
import nnnnarisa.narisacore.world.gen.structure.StructureSmallHousePieces;

import java.util.Random;

public class NCDebugDummyMapGen extends MapGenScatteredFeature{
    private final int fixedHeight;
    private final int minDist, maxDist;
    private final String namespace, location;

    public NCDebugDummyMapGen(int fixedHeight, int minDist, int maxDist, String namespace, String location){
        super();
    ...
    protected StructureStart getStructureStart(int chunkX, int chunkZ){
        return new NCDebugDummyMapGen.Start(this.rand, chunkX, chunkZ, this.fixedHeight, this.namespace, this.location);
    }
