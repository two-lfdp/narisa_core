...
public class NCItemShovel extends ItemSpade {
    private final ItemStack smeltResult;

    private final String modId, snakeName;

    public NCItemShovel(ToolMaterial material, String modId, String headCapitalName, String snakeName,
        ...
        setUnlocalizedName("shovel" + headCapitalName);
        setRegistryName(modId, "shovel_" + snakeName);
    ...
    public void registerModels(ModelRegistryEvent event){
        ModelLoader.setCustomModelResourceLocation(this, 0, new ModelResourceLocation(
                new ResourceLocation(modId, "tools/shovel_" + snakeName),
                "inventory"));
    }
